...
__decorate([
    ...
    __metadata("design:type", String)
], Exposicion.prototype, "fecha_inicio", void 0);
__decorate([
    (0, graphql_1.Field)({ nullable: true }),
    (0, typeorm_1.Column)({ type: 'date', nullable: true }),
    __metadata("design:type", String)
], Exposicion.prototype, "fecha_fin", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => galeria_entity_1.Galeria, galeria => galeria.id_galeria, { nullable: false }),
    __metadata("design:type", galeria_entity_1.Galeria)
], Exposicion.prototype, "galeria", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => artista_entity_1.Artista, artista => artista.id_artista, { nullable: true }),
