...
const galleries_resolver_1 = require("./galleries.resolver");
...
exports.GalleriesModule = GalleriesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [galleries_service_1.GalleriesService, galleries_resolver_1.GalleriesResolver],
        exports: [galleries_service_1.GalleriesService],
    })
], GalleriesModule);
